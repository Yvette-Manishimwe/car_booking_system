...
class _BookingConfirmationScreenState extends State<BookingConfirmationScreen> {
  ...
  Future<void> _fetchAvailableSeats() async {
    final url = Uri.parse('http://192.168.1.70:5000/get_trip_details/${widget.tripId}'); // Replace with your endpoint
    try {
  ...
  Future<void> _confirmBooking() async {
    final url = Uri.parse('http://192.168.1.70:5000/book_trip');
