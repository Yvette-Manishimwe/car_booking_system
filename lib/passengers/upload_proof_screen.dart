...
class _UploadProofScreenState extends State<UploadProofScreen> {
  ...
  Future<void> _uploadProof() async {
    ...
    var request = http.MultipartRequest(
      'POST',
      Uri.parse('http://192.168.8.104:5000/upload_proof/${widget.bookingId}'),
    );
  ...
  Future<void> _verifyPayment() async {
    ...
    final response = await http.post(
      Uri.parse('http://192.168.8.104:5000/verify_payment/${widget.bookingId}'),
      headers: {
  ...
  Future<void> _submitRating() async {
    ...
    final response = await http.post(
      Uri.parse('http://192.168.8.104:5000/rate_driver'),
      headers: {
